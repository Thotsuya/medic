                    ...
                    <div class="p-3 mb-3 invoice">
                        ...
                        <!-- Table row -->
                            <div class="row">
                                ...
                                <div class="col-12 table-responsive">
                                    <table class="table table-striped table-sm">
                                        ...
                                        <tr v-if="proceduresList.length" v-for="procedure in proceduresList" :key="procedure.id">
                                            ...
                                            <td><input v-model="procedure.unformatted_price" type="number" step="any"  class="form-control"></td>
                                            <td class="text-center"><input v-model="procedure.discount" type="number" step="any" class="form-control"></td>
                                            <td class="text-center"><input v-model="procedure.amount" type="number" class="form-control"></td>
                                ...
                                <!-- /.col -->
                                <div class="col-12">
                                    <button type="button" @click="updateAttention" class=" float-right btn btn-success"><i class="fas fa-save mr-2"></i>Guardar Cambios</button>
                                </div>
                            ...
                            <div class="col-12 table-responsive">
                                <table class="table table-striped table-sm">
                                    ...
                                    <tr v-if="attention.data.has_payments" v-for="payment in attention.payments" :key="payment.id">
                                        ...
                                        <td class="text-center">
                                            <button type="button" @click="deletePayment(payment)" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></button>
                                        </td>
                                    </tr>
                                    <tr v-else>
                        ...
                        <div class="row no-print">
                            <div class="col-12">
                                ...
                                <button type="button" class="float-right btn btn-success" data-bs-toggle="modal" data-bs-target="#paymentModal">
                                    <i class="far fa-credit-card"></i> Generar Pago
                                </button>
...
<!--                                </a>-->
                                ...
                                <Link :href="route('attentions.edit',attention)" class="float-right btn btn-warning mr-2">
