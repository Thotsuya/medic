                ...
                <div class="col-lg-8">
                    <div class="card card-primary card-outline">
                                        ...
                                        <tr v-if="proceduresList.length" v-for="(procedure,index) in proceduresList"
                                            ...
                                            <td>
                                                <input v-model="procedure.amount" type="number" step="any"
                                                       class="form-control"
                                                       :class="{ 'is-invalid' : valuationForm.errors[`procedures.${index}.amount`] }">
                                                <span class="text-danger text-sm"
                                                      v-if="valuationForm.errors[`procedures.${index}.amount`]">{{
                                                        valuationForm.errors[`procedures.${index}.amount`]
                                                    }}</span>
                                            </td>
                                            <td>
                                                <input v-model="procedure.discount" type="number" step="any"
                                                       class="form-control"
                                                       :class="{ 'is-invalid' : valuationForm.errors[`procedures.${index}.discount`] }">
                                                <span class="text-danger text-sm"
                                                      v-if="valuationForm.errors[`procedures.${index}.discount`]">{{
                                                        valuationForm.errors[`procedures.${index}.discount`]
                                                    }}</span>
                                            </td>
                        ...
                        <div class="card-footer">
                            <button class="btn btn-primary float-right" @click="storeValuation"><i
...
export default {
    ...
    setup(props) {
        ...
        const {valuationForm, proceduresList, storeValuation, addProcedure, removeProcedure} = useValuation()
